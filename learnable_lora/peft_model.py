...
class CustomPeftModel(PushToHubMixin, torch.nn.Module):
    """
...
class PeftModelForSequenceClassification(CustomPeftModel):
    """
...
class PeftModelForCausalLM(CustomPeftModel):
    """
...
class PeftModelForSeq2SeqLM(CustomPeftModel):
    """
...
class PeftModelForTokenClassification(CustomPeftModel):
    """
...
class PeftModelForQuestionAnswering(CustomPeftModel):
    """
...
class PeftModelForFeatureExtraction(CustomPeftModel):
    """
