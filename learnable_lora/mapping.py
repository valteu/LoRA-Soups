...
MODEL_TYPE_TO_PEFT_MODEL_MAPPING: Dict[str, CustomPeftModel] = {
...
def get_peft_model(model: PreTrainedModel, peft_config: PeftConfig, adapter_name: str = "default") -> CustomPeftModel:
    """
    ...
    if peft_config.task_type not in MODEL_TYPE_TO_PEFT_MODEL_MAPPING.keys() and not peft_config.is_prompt_learning:
        return CustomPeftModel(model, peft_config, adapter_name=adapter_name)
